...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const { token, role, username } = data; // Assuming backend sends role and username
  ...
  return (
    <div className="min-h-screen flex bg-slate-50">
      {/* Left Column: Visual */}
      <div className="hidden md:block md:w-1/2 lg:w-2/3 bg-cover bg-center" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1542744173-8e7e53415bb0?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80')" }}>
